...
## 六、IO流
### 0、如何在maven中的calsspath中获得文件或者输入流
####  0.1、[在非静态方法时](https://blog.csdn.net/Mosqiote/article/details/104264449)
####  0.2、在静态方法时 我们必须通过当前类.class.getClassLoader(); 这样才能知道这是本项目,不能使用Class.class.getClassLoder() 不然不知道时那个类所以无法正常获取类加载器
### 1、File类的使用
#### 1.1、File类的理解
